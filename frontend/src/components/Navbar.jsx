        ...
        <nav className="flex items-center justify-between px-6 lg:px-12 py-6 relative">
            ...
            <div className="flex items-center space-x-3 relative">                <button 
                ...
                {isSettingsOpen && (
                    <div 
                        ref={settingsMenuRef}
                        className={`absolute top-12 right-0 bg-gray-900/80 backdrop-blur-md border border-gray-600/50 rounded-lg shadow-2xl p-6 min-w-80 z-50 transition-all duration-200 ease-out transform origin-top-right ${
